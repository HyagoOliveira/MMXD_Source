	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target.x = dot(float2(1.16438, 1.59603), tmp0.xy);
                o.sv_target.y = dot(float3(1.16438, -0.39176, -0.81297), tmp0.xyz);
