...
public class CardColumeSmall : ScrollIndexCallback
{
	...
	public override void ScrollCellIndex(int p_idx)
	{
		...
		while (num2 < 2)
		{
			...
			if (ManagedSingleton<OrangeDataManager>.Instance.WEAPON_TABLE_DICT.ContainsKey(netInfo.WeaponID))
			{
				...
				allPerPerWeaponSmallCells[num2].tWeaponIconBase.Setup(0, AssetBundleScriptableObject.Instance.m_iconWeapon, wEAPON_TABLE.s_ICON, allPerPerWeaponSmallCells[num2].OnClick, whiteColor);
				...
				if (netInfo.WeaponID == goCheckUI.nMainWeaponID)
				{
					...
					allPerPerWeaponSmallCells[num2].tWeaponIconBase.SetOtherInfo(netInfo, CommonIconBase.WeaponEquipType.Main);
				}
				else if (netInfo.WeaponID == goCheckUI.nSubWeaponID)
				{
					...
					allPerPerWeaponSmallCells[num2].tWeaponIconBase.SetOtherInfo(netInfo, CommonIconBase.WeaponEquipType.Sub);
				}
				else
				{
					allPerPerWeaponSmallCells[num2].tWeaponIconBase.SetOtherInfo(netInfo, CommonIconBase.WeaponEquipType.UnEquip);
				}
