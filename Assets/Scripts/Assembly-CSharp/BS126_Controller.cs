...
public class BS126_Controller : EnemyControllerBase, IManagedUpdateBehavior
{
	...
	public enum AnimationID
	{
		...
		ANI_SKILL0_START1 = 9,
		ANI_SKILL0_LOOP1 = 10,
		ANI_SKILL0_START2 = 11,
		ANI_SKILL0_LOOP2 = 12,
		ANI_SKILL0_START3 = 13,
		ANI_SKILL0_END3 = 14,
		ANI_SKILL1_START1 = 15,
		ANI_SKILL1_LOOP1 = 16,
		ANI_SKILL1_START2 = 17,
		ANI_SKILL1_END2 = 18,
		ANI_SKILL2_START = 19,
		ANI_SKILL2_LOOP = 20,
		ANI_SKILL2_END = 21,
		...
		ANI_SKILL7_LOOP = 37,
		ANI_SKILL7_END = 38,
		ANI_SKILL8_START1 = 39,
		ANI_SKILL8_LOOP1 = 40,
		ANI_SKILL8_START2 = 41,
		ANI_SKILL8_LOOP2 = 42,
		ANI_SKILL8_START3 = 43,
		ANI_SKILL8_LOOP3 = 44,
		ANI_SKILL8_END3 = 45,
		ANI_SKILL9_START1 = 46,
		ANI_SKILL9_LOOP1 = 47,
		ANI_SKILL9_END1 = 48,
		ANI_SKILL9_START2 = 49,
		ANI_SKILL9_LOOP2 = 50,
		ANI_SKILL9_START3 = 51,
		ANI_SKILL9_LOOP3 = 52,
		ANI_SKILL9_END3 = 53,
		ANI_SKILL9_START4 = 54,
		ANI_SKILL9_LOOP4 = 55,
		ANI_SKILL9_START5 = 56,
		ANI_SKILL9_LOOP5 = 57,
		ANI_SKILL9_END5 = 58,
		ANI_SKILL9_START6 = 59,
		ANI_SKILL9_LOOP6 = 60,
		ANI_SKILL9_END6 = 61,
		ANI_SKILL9_START7 = 62,
		ANI_SKILL9_LOOP7 = 63,
		ANI_SKILL9_START8 = 64,
		ANI_SKILL9_LOOP8 = 65,
		ANI_SKILL9_END8 = 66,
		ANI_SKILL10_START = 67,
		ANI_SKILL10_LOOP = 68,
		ANI_SKILL10_END = 69,
		ANI_SKILL11_START = 70,
		ANI_END_LOOP0 = 71,
		ANI_END_START1 = 72,
		ANI_END_LOOP1 = 73,
		ANI_END_START2 = 74,
	...
	[Header("登場用")]
	[SerializeField]
	private Transform DebutModel;

	[SerializeField]
	private ParticleSystem DebutFX1;

	[SerializeField]
	private ParticleSystem DebutFX2;

	[SerializeField]
	private ParticleSystem DebutFX3;

	[Header("劇情用")]
	[SerializeField]
	private Transform EndingModel;

	[SerializeField]
	private GameObject[] ICOMesh = new GameObject[4];

	[SerializeField]
	private ParticleSystem ICOWingFX;
	...
	[SerializeField]
	private Transform InGameModel;

	[SerializeField]
	private GameObject WingObj;
	...
	[SerializeField]
	private ParticleSystem Sk10FX1;

	[SerializeField]
	private ParticleSystem Sk10FX2;

	[Header("斬躪刃")]
	[SerializeField]
	private int DefaultSk11UseTimes = 2;

	[SerializeField]
	private ParticleSystem Sk11FX;
	...
	protected void ChangeSetSkill(object[] param)
	{
		...
		if (!(text == string.Empty))
		{
			...
			case "Skill9":
				...
				break;
			case "Skill10":
				NextSkill = MainStatus.Skill10;
				break;
			case "Skill11":
				NextSkill = MainStatus.Skill11;
				break;
			}
		}
	}
	...
	{
		DebutModel.gameObject.SetActive(false);
		EndingModel.gameObject.SetActive(false);
		HandSowrd.SetActive(false);
		LHandSowrd.SetActive(false);
		HandGunL.SetActive(false);
		HandGunR.SetActive(false);
		IsChipInfoAnim = true;
	}

	protected virtual void HashAnimation()
	{
		_animationHash = new int[90];
		_animationHash[1] = Animator.StringToHash("bs126_debut_phase1_loop");
		_animationHash[2] = Animator.StringToHash("bs126_debut_phase2_start");
		_animationHash[3] = Animator.StringToHash("bs126_debut_phase2_loop");
		_animationHash[4] = Animator.StringToHash("bs126_debut_phase3_start");
		_animationHash[5] = Animator.StringToHash("BS086@debut_step1");
		_animationHash[6] = Animator.StringToHash("BS086@debut_step2");
		_animationHash[7] = Animator.StringToHash("BS086@debut_step3");
		_animationHash[8] = Animator.StringToHash("BS126@debut_step4");
		_animationHash[0] = Animator.StringToHash("bs126_stand_loop");
		_animationHash[9] = Animator.StringToHash("BS086@skill_01_step1_start");
		_animationHash[10] = Animator.StringToHash("BS086@skill_01_step1_loop");
		_animationHash[11] = Animator.StringToHash("BS086@skill_01_step2_start");
		_animationHash[12] = Animator.StringToHash("BS086@skill_01_step2_loop");
		_animationHash[13] = Animator.StringToHash("BS086@skill_01_step3_start");
		_animationHash[14] = Animator.StringToHash("BS086@skill_01_step3_end");
		_animationHash[15] = Animator.StringToHash("BS086@skill_02_step1_start");
		_animationHash[16] = Animator.StringToHash("BS086@skill_02_step1_loop");
		_animationHash[17] = Animator.StringToHash("BS086@skill_02_step2_start");
		_animationHash[18] = Animator.StringToHash("BS086@skill_02_step2_end");
		_animationHash[19] = Animator.StringToHash("BS086@skill_03_start");
		_animationHash[20] = Animator.StringToHash("BS086@skill_03_loop");
		_animationHash[21] = Animator.StringToHash("BS086@skill_03_end");
		_animationHash[22] = Animator.StringToHash("BS086@skill_04_start");
		_animationHash[23] = Animator.StringToHash("BS086@skill_04_loop");
		_animationHash[24] = Animator.StringToHash("BS086@skill_04_end");
		_animationHash[25] = Animator.StringToHash("BS086@skill_05_step1_start");
		_animationHash[26] = Animator.StringToHash("BS086@skill_05_step1_loop");
		_animationHash[27] = Animator.StringToHash("BS086@skill_05_step2_start");
		_animationHash[28] = Animator.StringToHash("BS086@skill_05_step2_loop");
		_animationHash[29] = Animator.StringToHash("BS086@skill_05_step2_end");
		_animationHash[30] = Animator.StringToHash("BS086@skill_06_start");
		_animationHash[31] = Animator.StringToHash("BS086@skill_06_loop");
		_animationHash[32] = Animator.StringToHash("BS086@skill_06_end");
		_animationHash[33] = Animator.StringToHash("ch073_skill_01_stand_start");
		_animationHash[34] = Animator.StringToHash("ch073_skill_01_stand_loop");
		_animationHash[35] = Animator.StringToHash("ch073_skill_01_stand_end");
		_animationHash[39] = Animator.StringToHash("BS060@skill_04_step1_start");
		_animationHash[40] = Animator.StringToHash("BS060@skill_04_step1_loop");
		_animationHash[41] = Animator.StringToHash("BS060@skill_04_step2_start");
		_animationHash[42] = Animator.StringToHash("BS060@skill_04_step2_loop");
		_animationHash[43] = Animator.StringToHash("BS060@skill_04_step3_start");
		_animationHash[44] = Animator.StringToHash("BS060@skill_04_step3_loop");
		_animationHash[45] = Animator.StringToHash("BS060@skill_04_step3_end");
		_animationHash[46] = Animator.StringToHash("BS060@skill_08_start");
		_animationHash[47] = Animator.StringToHash("BS060@skill_08_loop");
		_animationHash[48] = Animator.StringToHash("BS060@skill_08_end");
		_animationHash[49] = Animator.StringToHash("BS060@skill_05_step1_start");
		_animationHash[50] = Animator.StringToHash("BS060@skill_05_step1_loop");
		_animationHash[51] = Animator.StringToHash("BS060@skill_05_step2_start");
		_animationHash[52] = Animator.StringToHash("BS060@skill_05_step2_loop");
		_animationHash[53] = Animator.StringToHash("BS060@skill_05_step2_end");
		_animationHash[54] = Animator.StringToHash("BS060@skill_05_step3_start");
		_animationHash[55] = Animator.StringToHash("BS060@skill_05_step3_loop");
		_animationHash[56] = Animator.StringToHash("BS060@skill_05_step4_start");
		_animationHash[57] = Animator.StringToHash("BS060@skill_05_step4_loop");
		_animationHash[58] = Animator.StringToHash("BS060@skill_05_step4_end");
		_animationHash[59] = Animator.StringToHash("BS060@skill_02_start");
		_animationHash[60] = Animator.StringToHash("BS060@skill_02_loop");
		_animationHash[61] = Animator.StringToHash("BS060@skill_02_end");
		_animationHash[62] = Animator.StringToHash("BS060@skill_06_step2_start");
		_animationHash[63] = Animator.StringToHash("BS060@skill_06_step2_loop");
		_animationHash[64] = Animator.StringToHash("BS060@skill_06_step3_start");
		_animationHash[65] = Animator.StringToHash("BS060@skill_06_step3_loop");
		_animationHash[66] = Animator.StringToHash("BS060@skill_06_step3_end");
		if (!Sk7UseNewMotion)
		{
			_animationHash[36] = Animator.StringToHash("ch019_skill_01_start");
			_animationHash[37] = Animator.StringToHash("ch019_skill_01_loop");
			_animationHash[38] = Animator.StringToHash("ch019_skill_01_end");
		}
		else
		{
			_animationHash[36] = Animator.StringToHash("BS086@skill_08_start");
			_animationHash[37] = Animator.StringToHash("BS086@skill_08_loop");
			_animationHash[38] = Animator.StringToHash("BS086@skill_08_end");
		}
		_animationHash[67] = Animator.StringToHash("ch123_skill_01_stand_start");
		_animationHash[68] = Animator.StringToHash("ch123_skill_01_loop");
		_animationHash[69] = Animator.StringToHash("ch123_skill_01_stand_end");
		_animationHash[70] = Animator.StringToHash("ch123_skill_02_stand");
		_animationHash[86] = Animator.StringToHash("BS086@hurt_loop");
		_animationHash[87] = Animator.StringToHash("BS086@dead");
		_animationHash[88] = Animator.StringToHash("BS086@dead_step1");
		_animationHash[89] = Animator.StringToHash("BS126@dead_step2");
		_animationHash[73] = Animator.StringToHash("final_event_@phase1_loop");
		_animationHash[74] = Animator.StringToHash("final_event_@phase2_start");
		_animationHash[75] = Animator.StringToHash("final_event_@phase2_loop");
		_animationHash[76] = Animator.StringToHash("final_event_@phase3_start");
		_animationHash[77] = Animator.StringToHash("final_event_@phase3_loop");
		_animationHash[78] = Animator.StringToHash("final_event_@phase4_start");
		_animationHash[79] = Animator.StringToHash("final_event_@phase4_loop");
		_animationHash[80] = Animator.StringToHash("final_event_@phase5_start");
		_animationHash[81] = Animator.StringToHash("final_event_@phase5_loop");
		_animationHash[82] = Animator.StringToHash("final_event_@phase6_start");
		_animationHash[83] = Animator.StringToHash("final_event_@phase6_loop");
		_animationHash[84] = Animator.StringToHash("final_event_@phase7_start");
		_animationHash[85] = Animator.StringToHash("final_event_@phase7_loop");
	}

	private void LoadParts(ref Transform[] childs)
	{
		InGameModel = OrangeBattleUtility.FindChildRecursive(ref childs, "model", true);
		DebutModel = OrangeBattleUtility.FindChildRecursive(ref childs, "debutmodel", true);
		EndingModel = OrangeBattleUtility.FindChildRecursive(ref childs, "endingmodel", true);
		if (ICOMesh[0] == null)
		{
			ICOMesh[0] = OrangeBattleUtility.FindChildRecursive(ref childs, "Ico_BodyMesh_m").gameObject;
		}
		if (ICOMesh[1] == null)
		{
			ICOMesh[1] = OrangeBattleUtility.FindChildRecursive(ref childs, "Ico_HandMesh_L_m").gameObject;
		}
		if (ICOMesh[2] == null)
		{
			ICOMesh[2] = OrangeBattleUtility.FindChildRecursive(ref childs, "Ico_HandMesh_R_m").gameObject;
		}
		if (ICOMesh[3] == null)
		{
			ICOMesh[3] = OrangeBattleUtility.FindChildRecursive(ref childs, "Ico_WingMesh_g001").gameObject;
		}
		if (ICOWingFX == null)
		{
			ICOWingFX = OrangeBattleUtility.FindChildRecursive(ref childs, "CH063_WingEffect", true).GetComponent<ParticleSystem>();
		}
		ModelTransform = DebutModel;
		...
		if (HandSowrd == null)
		{
			HandSowrd = OrangeBattleUtility.FindChildRecursive(ref childs, "BS126_SaberR", true).gameObject;
		}
		if (LHandSowrd == null)
		{
			LHandSowrd = OrangeBattleUtility.FindChildRecursive(ref childs, "BS126_SaberL", true).gameObject;
		}
		if (HandGunL == null)
		{
		...
		if (WingObj == null)
		{
			WingObj = OrangeBattleUtility.FindChildRecursive(ref childs, "Fx_ViaWing_01", true).gameObject;
		}
		if (RedAura == null)
		{
		...
		if (Sk8FX == null)
		{
			Sk8FX = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk8FX", true).GetComponent<ParticleSystem>();
		}
		if (Sk9FX1 == null)
		{
			Sk9FX1 = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk9FX1", true).GetComponent<ParticleSystem>();
		}
		if (Sk9FX2 == null)
		{
			Sk9FX2 = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk9FX2", true).GetComponent<ParticleSystem>();
		}
		if (Sk9FX3 == null)
		{
			Sk9FX3 = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk9FX3", true).GetComponent<ParticleSystem>();
		}
		if (Sk9FX4 == null)
		{
			Sk9FX4 = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk9FX4", true).GetComponent<ParticleSystem>();
		}
		if (Sk10FX1 == null)
		{
			Sk10FX1 = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk10FX1", true).GetComponent<ParticleSystem>();
		}
		if (Sk10FX2 == null)
		{
			Sk10FX2 = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk10FX2", true).GetComponent<ParticleSystem>();
		}
		if (Sk11FX == null)
		{
			Sk11FX = OrangeBattleUtility.FindChildRecursive(ref childs, "Sk11FX", true).GetComponent<ParticleSystem>();
		}
		if (DebutFX1 == null)
		{
			DebutFX1 = OrangeBattleUtility.FindChildRecursive(ref childs, "DebutFX1", true).GetComponent<ParticleSystem>();
		}
		if (DebutFX2 == null)
		{
			DebutFX2 = OrangeBattleUtility.FindChildRecursive(ref childs, "DebutFX2", true).GetComponent<ParticleSystem>();
		}
		if (DebutFX3 == null)
		{
			DebutFX3 = OrangeBattleUtility.FindChildRecursive(ref childs, "DebutFX3", true).GetComponent<ParticleSystem>();
		}
		if (CatchTool == null)
		{
	...
	private void SetStatus(MainStatus mainStatus, SubStatus subStatus = SubStatus.Phase0)
	{
		...
		case MainStatus.Debut:
		{
			...
			case SubStatus.Phase0:
				...
				UseRGun(false);
				TakeSword(false);
				SwitchModel(DebutModel);
				break;
			case SubStatus.Phase1:
				base.SoundSource.PlaySE("BossSE03", "bs030_via26");
				SwitchFx(DebutFX1, true);
				break;
			case SubStatus.Phase2:
				SwitchFx(DebutFX2, true);
				break;
			case SubStatus.Phase3:
				SwitchModel(InGameModel);
				SwitchFx(DebutFX3, true);
				hasActed = false;
				break;
			}
			break;
		...
		case MainStatus.Skill10:
			...
			case SubStatus.Phase0:
				...
				break;
			case SubStatus.Phase1:
				_velocity.x = Sk10Spd * base.direction;
				base.SoundSource.PlaySE("BossSE03", "bs030_via28");
				if ((bool)Sk10FX1)
				{
					SwitchFx(Sk10FX1, true);
				}
				if ((bool)Sk10FX2)
				{
					SwitchFx(Sk10FX2, true);
				}
				_collideBullet.UpdateBulletData(EnemyWeapons[GetWeaponID(UseSkill.Sk10Dash)].BulletData);
				_collideBullet.SetBulletAtk(null, selfBuffManager.sBuffStatus, EnemyData);
				_collideBullet.Active(targetMask);
				break;
			case SubStatus.Phase2:
				if ((bool)Sk10FX1)
				{
					SwitchFx(Sk10FX1, false);
				}
				if ((bool)Sk10FX2)
				{
					SwitchFx(Sk10FX2, false);
				}
				hasActed = false;
				_collideBullet.UpdateBulletData(EnemyWeapons[GetWeaponID(UseSkill.BodyCollide)].BulletData);
				_collideBullet.SetBulletAtk(null, selfBuffManager.sBuffStatus, EnemyData);
			...
			break;
		case MainStatus.Skill11:
			if (_subStatus == SubStatus.Phase0)
			{
				TakeLSword(true);
				TakeSword(true);
				Sk11UseTimes = DefaultSk11UseTimes;
			}
			break;
		case MainStatus.Die:
			switch (_subStatus)
			...
			case SubStatus.Phase2:
				...
				BackToPool();
				StartCoroutine(OnToggleWing(0.2f));
				break;
			case SubStatus.Phase3:
		...
		case MainStatus.Ending:
			...
			case SubStatus.Phase0:
				...
				SwitchModel(EndingModel);
				SwitchICOMesh(false);
				_transform.position = NowPos + 1.5f * Vector3.right * base.direction;
	...
	private void UpdateAnimation()
	{
		...
		case MainStatus.Debut:
		{
			...
			if (aiState == AI_STATE.mob_003)
			{
				...
				{
				case SubStatus.Phase0:
					_currentAnimationId = AnimationID.ANI_ORI_DEBUT1;
					break;
				case SubStatus.Phase1:
					_currentAnimationId = AnimationID.ANI_ORI_DEBUT2;
					return;
				case SubStatus.Phase2:
					_currentAnimationId = AnimationID.ANI_ORI_DEBUT3;
					break;
				case SubStatus.Phase3:
					_currentAnimationId = AnimationID.ANI_ORI_DEBUT4;
					break;
				case SubStatus.Phase4:
		...
		case MainStatus.Skill10:
			...
			{
			case SubStatus.Phase0:
				_currentAnimationId = AnimationID.ANI_SKILL10_START;
				break;
			case SubStatus.Phase1:
				_currentAnimationId = AnimationID.ANI_SKILL10_LOOP;
				break;
			case SubStatus.Phase2:
				_currentAnimationId = AnimationID.ANI_SKILL10_END;
				break;
			}
			break;
		case MainStatus.Skill11:
			if (_subStatus == SubStatus.Phase0)
			{
				_currentAnimationId = AnimationID.ANI_SKILL11_START;
			}
			break;
		case MainStatus.Die:
			switch (_subStatus)
		...
		case MainStatus.Ending:
			...
			{
			case SubStatus.Phase0:
				_currentAnimationId = AnimationID.ANI_END_LOOP1;
				break;
			case SubStatus.Phase1:
				_currentAnimationId = AnimationID.ANI_END_START2;
				break;
			case SubStatus.Phase2:
				_currentAnimationId = AnimationID.ANI_END_LOOP2;
				break;
			case SubStatus.Phase3:
				_currentAnimationId = AnimationID.ANI_END_START3;
				break;
			case SubStatus.Phase4:
				_currentAnimationId = AnimationID.ANI_END_START4;
				break;
			case SubStatus.Phase5:
				_currentAnimationId = AnimationID.ANI_END_START5;
				break;
			case SubStatus.Phase6:
				_currentAnimationId = AnimationID.ANI_END_START6;
				break;
			case SubStatus.Phase7:
				_currentAnimationId = AnimationID.ANI_END_START7;
				break;
			}
			break;
		}
	...
	public override void LogicUpdate()
	{
		...
		if (!Activate)
		{
			...
			else if (_mainStatus != MainStatus.Debut && _mainStatus != MainStatus.Ending && _mainStatus != MainStatus.Die)
			{
				return;
			}
		}
		...
		case MainStatus.Debut:
		{
			...
			case SubStatus.Phase2:
				...
				break;
			case SubStatus.Phase3:
				if (!hasActed && _currentFrame > 0.55f)
				{
					hasActed = true;
					base.SoundSource.PlaySE("BossSE03", "bs030_via02");
				}
				if (_currentFrame > 1f)
				{
					SetStatus(MainStatus.Debut, SubStatus.Phase4);
		...
		case MainStatus.Skill0:
			...
			case SubStatus.Phase0:
				...
				break;
			case SubStatus.Phase1:
				if (!hasActed && _currentFrame > ShootFrame)
				{
					hasActed = true;
		...
		case MainStatus.Skill3:
			...
			case SubStatus.Phase1:
				if (!hasActed && _currentFrame > ShootFrame)
				{
					...
					{
						Vector3 vector2 = Quaternion.Euler(0f, 0f, num * (float)k * (float)base.direction) * (Vector3.right * base.direction);
		...
		case MainStatus.Skill6:
			...
			case SubStatus.Phase1:
				...
				{
					Vector3 worldPos = RShootPos.position + Vector3.up * OrangeBattleUtility.Random(-1, 2) * 0.1f + Vector3.right * ((float)base.direction * 1.5f);
					BulletBase.TryShotBullet(EnemyWeapons[GetWeaponID(UseSkill.Sk6Bullet)].BulletData, worldPos, Vector3.right * base.direction, null, selfBuffManager.sBuffStatus, EnemyData, targetMask);
					if (--Sk6AtkTimes > 0)
					{
		...
		case MainStatus.Skill8:
			...
			case SubStatus.Phase3:
				...
				if (!hasActed && _currentFrame > 0.2f)
				{
					...
					for (int j = 0; j < 8; j++)
					{
						Vector3 vector = Quaternion.Euler(0f, 0f, (float)(j * 45) + 22.5f) * Vector3.up;
						Vector3 worldPos2 = new Vector3(0f, 0.5f, 0f) + vector * 0.5f + _transform.position;
						BulletBase.TryShotBullet(EnemyWeapons[GetWeaponID(UseSkill.Sk0Bullet2)].BulletData, worldPos2, vector, null, selfBuffManager.sBuffStatus, EnemyData, targetMask)._transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
					}
				}
				break;
			case SubStatus.Phase4:
		...
		case MainStatus.Skill10:
			...
			case SubStatus.Phase0:
				if (_currentFrame > 1f)
				{
					SetStatus(MainStatus.Skill10, SubStatus.Phase1);
				}
				break;
			case SubStatus.Phase1:
				if ((_transform.position.x - EndPos.x) * (float)base.direction > 0f || (base.direction == 1 && Controller.Collisions.right) || (base.direction == -1 && Controller.Collisions.left))
				{
					SetStatus(MainStatus.Skill10, SubStatus.Phase2);
				}
				break;
			case SubStatus.Phase2:
				...
				{
					hasActed = true;
					BulletBase.TryShotBullet(EnemyWeapons[GetWeaponID(UseSkill.Sk10Fire)].BulletData, NowPos, Vector3.zero, null, selfBuffManager.sBuffStatus, EnemyData, targetMask);
					base.SoundSource.PlaySE("BossSE03", "bs030_via29");
				}
				if (_currentFrame > 1f)
				{
					SetStatus(MainStatus.Idle);
		...
		case MainStatus.Skill11:
			...
			if (_currentFrame > 0.11f && Sk11UseTimes > 1)
			{
				if ((bool)Sk11FX)
				{
					SwitchFx(Sk11FX, true);
				}
				Sk11UseTimes--;
				BulletBase.TryShotBullet(EnemyWeapons[GetWeaponID(UseSkill.Sk11Bullet)].BulletData, RShootPos.position, Vector3.right * base.direction, null, selfBuffManager.sBuffStatus, EnemyData, targetMask);
				base.SoundSource.PlaySE("BossSE03", "bs030_via30");
			}
			if (_currentFrame > 0.25f && Sk11UseTimes > 0)
			{
				Sk11UseTimes--;
				BulletBase.TryShotBullet(EnemyWeapons[GetWeaponID(UseSkill.Sk11Bullet)].BulletData, RShootPos.position, Vector3.right * base.direction, null, selfBuffManager.sBuffStatus, EnemyData, targetMask);
			}
		...
		case MainStatus.Ending:
			...
			{
			case SubStatus.Phase0:
				if (_animator.GetInteger("NowStatus") == 2)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase1);
				}
				break;
			case SubStatus.Phase1:
				if (_currentFrame > 1f)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase2);
				}
				break;
			case SubStatus.Phase2:
				if (_animator.GetInteger("NowStatus") == 3)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase3);
				}
				break;
			case SubStatus.Phase3:
				if (!hasActed && _currentFrame > 0.25f)
				{
					SwitchICOMesh(true);
					hasActed = true;
				}
				if (_animator.GetInteger("NowStatus") == 4)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase4);
				}
				break;
			case SubStatus.Phase4:
				if (nCount == 46)
				{
					base.SoundSource.PlaySE("BattleSE", "bt_xu_charge_stop");
					base.SoundSource.PlaySE("BossSE04", "bs040_kai02");
				}
				if (!hasActed && nCount > 1 && _currentFrame > 0.75f)
				{
					hasActed = true;
					nCount = 0;
					base.SoundSource.PlaySE("BattleSE", "bt_xu_charge_lp");
				}
				nCount++;
				if (_animator.GetInteger("NowStatus") == 5)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase5);
				}
				break;
			case SubStatus.Phase5:
				if (_animator.GetInteger("NowStatus") == 6)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase6);
				}
				break;
			case SubStatus.Phase6:
				if (_animator.GetInteger("NowStatus") == 7)
				{
					SetStatus(MainStatus.Ending, SubStatus.Phase7);
				}
				break;
			case SubStatus.Phase7:
				if (!hasActed && _currentFrame > 1.5f)
				{
					hasActed = true;
	...
	public override void SetActive(bool isActive)
	{
		...
		if (isActive)
		{
			...
			TakeLSword(false);
			CheckRoomSize();
			InGameModel.gameObject.SetActive(false);
			EndingModel.gameObject.SetActive(false);
	...
	private IEnumerator OnToggleWing(float delay)
	{
	...
	protected override void DeadBehavior(ref HurtPassParam tHurtPassParam)
	{
		if (_mainStatus != MainStatus.Die)
		{
			...
			base.SoundSource.PlaySE("BossSE03", "bs030_via27", 0.5f);
			AI_STATE aiState = AiState;
			if (aiState == AI_STATE.mob_002)
			{
				SetStatus(MainStatus.Ending);
	...
	public override void UpdateEnemyID(int id)
	{
		...
		UpdateAIState();
		AI_STATE aiState = AiState;
		DefaultSkillCard = new int[7] { 0, 5, 6, 8, 9, 10, 11 };
		DefaultRangedSkillCard = new int[3] { 5, 8, 10 };
		if ((bool)AuraFX2)
		{
			SwitchFx(AuraFX2, false);
		}
	...
	private void SwitchModel(Transform model)
	{
	...
	private void SwitchICOMesh(bool onoff)
	{
		GameObject[] iCOMesh = ICOMesh;
		foreach (GameObject gameObject in iCOMesh)
		{
			if (gameObject != null)
			{
	...
	private int GetWeaponID(UseSkill skill)
	{
		...
		case UseSkill.Sk9Slash:
			return 6;
		case UseSkill.Sk10Dash:
			return 7;
		case UseSkill.Sk10Fire:
			return 8;
		case UseSkill.Sk11Bullet:
			return 9;
		default:
