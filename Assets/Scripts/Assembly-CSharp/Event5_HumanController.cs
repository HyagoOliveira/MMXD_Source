...
public class Event5_HumanController : EnemyHumanController
{
	...
	protected override void AwakeJob()
	{
		base.AwakeJob();
		HashIdleAnimation();
		MonoBehaviourSingleton<FxManager>.Instance.PreloadFx("fxuse_lineup_angry_frame", 5);
	}
