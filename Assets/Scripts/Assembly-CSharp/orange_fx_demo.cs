...
public class orange_fx_demo : MonoBehaviour
{
	private int index;
	...
	private void Start()
	{
		DirectoryInfo directoryInfo = new DirectoryInfo(Application.dataPath + "/Main/Art/NewFX");
		fileInfo = directoryInfo.GetFiles("*(work).prefab", SearchOption.AllDirectories);
