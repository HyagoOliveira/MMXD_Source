...
namespace UnityChan
{
    public class SpringBone : MonoBehaviour
    {
        ...
        private float sqrDt = 0.0002562817f;
        ...
        private void Offset()
        {
            if (UseOffset)
            {
                base.transform.localPosition = offsetPos;
            }
        }
        ...
        public void UpdateSpring()
        {
            ...
            Vector3 vector = trs.rotation * (boneAxis * stiffnessForce) / sqrDt;
            vector += (prevTipPos - currTipPos) * dragForce / sqrDt;
            vector += springForce / sqrDt;
            Vector3 vector2 = currTipPos;
            currTipPos = currTipPos - prevTipPos + currTipPos + vector * sqrDt;
