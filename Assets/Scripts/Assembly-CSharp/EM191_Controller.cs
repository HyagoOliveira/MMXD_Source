...
public class EM191_Controller : EnemyControllerBase, IManagedUpdateBehavior
{
	...
	private BS107_Controller _parentController;
	...
	private void SetStatus(MainStatus mainStatus, SubStatus subStatus = SubStatus.Phase0)
	{
		...
		case MainStatus.Explosion:
			...
			_isExplosion = true;
			ActionFrame = GameLogicUpdateManager.GameFrame + 10;
			break;
		}
		AiTimer.TimerStart();
		UpdateAnimation();
	...
	public override void LogicUpdate()
	{
		...
		if (!_isExplosion && _mainStatus != MainStatus.Fall && (bool)Physics2D.OverlapBox(_transform.position, Vector2.one * 3f, 0f, LayerMask.GetMask("Player")))
		{
		...
		if (_transform.position.y > LimitY)
		{
			...
			hurtPassParam2.dmg = MaxHp;
			DeadBehavior(ref hurtPassParam2);
		}
	}
	...
	public override void SetActive(bool isActive)
	{
		...
		if (isActive)
		{
			ModelTransform.localScale = new Vector3(5.5f, 5.5f, 5.5f * (float)base.direction);
	...
	public void SetParent(BS107_Controller parent)
	{
	...
	private void SetColliderOffset(Vector2 offset)
	{
		...
		_enemyCollider[0].SetOffset(offset);
	}
}
