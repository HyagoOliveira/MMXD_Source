...
public class BS013_Controller : EnemyControllerBase, IManagedUpdateBehavior
{
		...
		case MainStatus.Skill1:
			...
			case SubStatus.Phase1:
				...
				else
				{
					...
					EM092_Controller[] array2 = new EM092_Controller[4];
					for (int num2 = ShootNum - 1; num2 >= 0; num2--)
					{
						...
						{
							array2[num2] = enemyControllerBase2.gameObject.GetComponent<EM092_Controller>();
							if ((bool)array2[num2])
							{
		...
		case MainStatus.Skill2:
			...
			case SubStatus.Phase1:
				...
				else
				{
					...
					EM099_Controller[] array = new EM099_Controller[4];
					for (int num = ShootNum - 1; num >= 0; num--)
					{
						...
						{
							array[num] = enemyControllerBase.gameObject.GetComponent<EM099_Controller>();
							if ((bool)array[num])
							{
