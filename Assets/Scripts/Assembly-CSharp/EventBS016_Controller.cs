...
public class EventBS016_Controller : EnemyControllerBase, IManagedUpdateBehavior
{
	...
	protected override void Awake()
	{
		...
		StageResManager.LoadBulletBySkillTable(ManagedSingleton<OrangeDataManager>.Instance.SKILL_TABLE_DICT[900005]);
	...
	private void SetStatus(MainStatus mainStatus, SubStatus subStatus = SubStatus.Phase0)
	{
		...
		case MainStatus.SceAct:
			...
			case SubStatus.Phase2:
				PlaySE("BossSE", 127);
				_ChargeEffect.Stop();
				BulletBase.TryShotBullet(ManagedSingleton<OrangeDataManager>.Instance.SKILL_TABLE_DICT[900005], _CannonShootPoint, Vector3.right * base.direction, null, selfBuffManager.sBuffStatus, EnemyData, targetMask, true);
				break;
			}
			break;
		}
		...
		if (Activate)
		{
			...
			case MainStatus.Trap:
				...
				case SubStatus.Phase1:
					...
					else if (!EnemyWeapons[4].LastUseTimer.IsStarted() || EnemyWeapons[4].LastUseTimer.GetMillisecond() > EnemyWeapons[4].BulletData.n_FIRE_SPEED)
					{
