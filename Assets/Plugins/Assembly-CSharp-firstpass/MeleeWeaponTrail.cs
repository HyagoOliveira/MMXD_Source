...
public class MeleeWeaponTrail : MonoBehaviour
{
    ...
    private List<Point> pointsToUse;

    private List<Point> remove = new List<Point>();
    ...
    private void Update()
    {
        ...
        Vector3[] array = new Vector3[pointsToUse.Count * 2];
        Vector2[] array2 = new Vector2[pointsToUse.Count * 2];
        int[] array3 = new int[(pointsToUse.Count - 1) * 6];
        Color[] array4 = new Color[pointsToUse.Count * 2];
        for (int k = 0; k < pointsToUse.Count; k++)
        {
            Point point3 = pointsToUse[k];
            ...
            float x = (float)k / (float)pointsToUse.Count;
