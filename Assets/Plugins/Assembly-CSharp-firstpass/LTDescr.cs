...
public class LTDescr
{
	...
	public void callOnCompletes()
	{
		...
		{
			Debug.LogError(string.Format("[{0}] {1}", "NullReferenceException", arg));
		}
		catch (Exception ex)
		{
			Debug.LogWarning("Callback funtion probably self destroyed by calling callOnCompletes! => " + ex.Message);
		}
	}
