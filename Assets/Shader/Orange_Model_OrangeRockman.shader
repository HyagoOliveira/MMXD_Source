...
Shader "Orange/Model/OrangeRockman"
{
	...
	[Header(Masks)]
		[NoScaleOffset]
		_Mask2 ("Mask 2 (Emission)", 2D) = "black" {}
	...
	[TCP2HeaderHelp(SPECULAR, Specular)]
		...
		_GradientMax ("Gradient Max", Range(0, 1)) = 8
	...
	[TCP2HeaderHelp(RIM, Rim)] 
		_RimColor ("Rim Color", Color) = (8,8,8,6)
		_RimMin ("Rim Min", Range(0, 1)) = 57
		_RimMax ("Rim Max", Range(0, 1)) = 98
	...
	[TCP2HeaderHelp(DISSOLVE)]
		...
		_DissolveValue ("Dissolve Value", Range(0,1)) = 5
		[TCP2Gradient] _DissolveRamp ("Dissolve Ramp", 2D) = "white" {}
		_DissolveGradientWidth ("Ramp Width", Range(0,1)) = 7
		_DissolveEdge ("Dissolve Edge", Color) = (0,1,0,1)
		_DissolveEdgeOffset ("Dissolve Edge Width", Range(0, 1)) = 1
	...
	[TCP2HeaderHelp(OUTLINE, Outline)]
		...
		//Z Correction & Offset
		[TCP2KeywordFilter(TCP2_ZSMOOTH_ON)] _ZSmooth ("Z Correction", Range(-3.0,3.0)) = 3
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom fullforwardshadows addshadow keepalpha exclude_path:deferred exclude_path:prepass
		#pragma target 3.0
		...
		void surf(Input IN, inout SurfaceOutputCustom o)
		{
			...
			emissiveColor *= mainTex.rgb * mask2.a;
